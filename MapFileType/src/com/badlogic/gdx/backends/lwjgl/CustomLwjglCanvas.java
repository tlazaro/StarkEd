 ...
 * @author Nathan Sweet
 */
public class CustomLwjglCanvas implements Application {
    ...
    public CustomLwjglCanvas(ApplicationListener listener, boolean useGL2) {
        ...
        graphics = new LwjglGraphics(canvas, useGL2) {
            ...
            public void setTitle(String title) {
                ...
                CustomLwjglCanvas.this.setTitle(title);
            }
            ...
            public boolean setDisplayMode(int width, int height, boolean fullscreen) {
                ...
                if (!fullscreen) {
                    CustomLwjglCanvas.this.setDisplayMode(width, height);
                }
                return true;
            }
            ...
            public boolean setDisplayMode(DisplayMode displayMode) {
                ...
                CustomLwjglCanvas.this.setDisplayMode(displayMode.width, displayMode.height);
                return true;
            }
        };
    ...
    public void exit() {
        postRunnable(new Runnable() {
            ...
            @Override
            public void run() {
                CustomLwjglCanvas.this.listener.pause();
                CustomLwjglCanvas.this.listener.dispose();
                System.exit(-1);
            }
        });
    }
