 ...
 * @author mzechner */
public class CustomLwjglGraphics implements Graphics {
	...
	CustomLwjglGraphics (LwjglApplicationConfiguration config) {
		this.config = config;
	}

	CustomLwjglGraphics (Canvas canvas, boolean useGL2IfAvailable) {
	...
	CustomLwjglGraphics (Canvas canvas, LwjglApplicationConfiguration config) {
		this.config = config;
