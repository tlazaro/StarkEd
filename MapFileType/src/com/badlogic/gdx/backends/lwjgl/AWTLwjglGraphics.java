 ...
 * @author mzechner
 */
public class AWTLwjglGraphics implements Graphics {
    ...
    AWTLwjglGraphics(AWTGLCanvas canvas, boolean useGL2IfAvailable) {
    ...
    AWTLwjglGraphics(AWTGLCanvas canvas, LwjglApplicationConfiguration config) {
        this.config = config;
    ...
    volatile private boolean setupDisplayDone = false;
    void setupDisplay() throws LWJGLException {
        if (!setupDisplayDone) {
            setupDisplayDone = true;
