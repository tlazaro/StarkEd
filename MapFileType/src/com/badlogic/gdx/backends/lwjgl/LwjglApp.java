...
public class LwjglApp implements Application {
    ...
    final AWTLwjglGraphics graphics;
    ...
    public LwjglApp(ApplicationListener listener, boolean useGL2) {
        LwjglNativesLoader.load();

        AWTGLCanvas canvas = addListener(listener);
        graphics = new AWTLwjglGraphics(canvas, useGL2) {

            public void setTitle(String title) {
                super.setTitle(title);
                LwjglApp.this.setTitle(title);
            }
            ...
            public boolean setDisplayMode(int width, int height, boolean fullscreen) {
                ...
                if (!fullscreen) {
                    LwjglApp.this.setDisplayMode(width, height);
                }
                return true;
            }
            ...
            public boolean setDisplayMode(DisplayMode displayMode) {
                ...
                LwjglApp.this.setDisplayMode(displayMode.width, displayMode.height);
                return true;
            }
        };
...
//                }
    ...
    public void stop() {
        ...
        EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                System.out.println("SUPER BIG DISPOSE");
                for (ApplicationListener listener : listeners) {
                    listener.pause();
                    listener.dispose();
                }
    ...
    public void exit() {
        postRunnable(new Runnable() {
            ...
            @Override
            public void run() {
                System.out.println("SUPER BIG EXIT");

                for (ApplicationListener listener : LwjglApp.this.listeners) {
                    listener.pause();
                    listener.dispose();
                }
                System.exit(-1);
