...
public class LwjglApp implements Application {
    ...
    public LwjglApp(ApplicationListener listener, boolean useGL2, boolean enableSound) {
        ...
        audio = enableSound ? new OpenALAudio() : null;
    ...
    public AWTGLCanvas addListener(final ApplicationListener listener) {
